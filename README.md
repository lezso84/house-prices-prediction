...
|---|---:|---:|---:|---|
| Untuned Decision Tree | 0.7409 | 26,132 | 39,211 | Severe overfitting |
| Tuned Decision Tree | 0.8020 | 23,322 | 33,072 | Improved, but still weak |
| Random Forest | 0.8732 | 18,294 | 26,463 | Stronger ensemble model |
| Log-Target Linear Regression | 0.8834 | 18,259 | 25,373 | Very strong baseline |
...
The log-target linear regression model was already a strong baseline, but Gradient Boosting improved the overall error profile and achieved the lowest RMSE among the tested models.
